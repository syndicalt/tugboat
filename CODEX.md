...
- Use [docs/integrations.md](docs/integrations.md) and [docs/instruction-best-practices.md](docs/instruction-best-practices.md) when onboarding agent tools or changing instruction-map structure.
- Use [docs/compatibility-policy.md](docs/compatibility-policy.md), [docs/llmff-compatibility.md](docs/llmff-compatibility.md), and [docs/migration-v1.md](docs/migration-v1.md) before changing v1 CLI, artifact, runner, or sidecar migration contracts.
...
- Release evidence lives in [docs/releases/0.1.0.md](docs/releases/0.1.0.md), [docs/releases/1.0.0-draft.md](docs/releases/1.0.0-draft.md), [docs/ops/security-review-2026-05-26.md](docs/ops/security-review-2026-05-26.md), [docs/releases/production-candidate.md](docs/releases/production-candidate.md), and [docs/ops/security-review-production-candidate.md](docs/ops/security-review-production-candidate.md).
- Roadmap and historical planning live in [docs/roadmaps/v1.0.0-roadmap.md](docs/roadmaps/v1.0.0-roadmap.md), [docs/roadmaps/2026-05-25-production-roadmap.md](docs/roadmaps/2026-05-25-production-roadmap.md), [docs/roadmaps/2026-05-27-next-roadmap-proposals.md](docs/roadmaps/2026-05-27-next-roadmap-proposals.md), and [docs/superpowers/plans/2026-05-25-agent-instruction-sidecar-mvp.md](docs/superpowers/plans/2026-05-25-agent-instruction-sidecar-mvp.md).
