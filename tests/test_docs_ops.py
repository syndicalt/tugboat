...
DOC_CONTRACTS = {
    ...
    ".github/ISSUE_TEMPLATE/v1_roadmap_item.yml": {
        "sections": [
            "name: v1 Roadmap Item",
            "description:",
            "labels:",
            "body:",
        ],
    ...
    "docs/compatibility-policy.md": {
        ...
        "required_text": [
            ...
            "fixture backend remains supported",
            "proposal-only by default",
            "read-only kill switch",
            "No hosted web UI",
        ],
    ...
    "docs/ops/release-checklist.md": {
        ...
        "required_text": [
            ...
            ".sidecar/ci/proposal-smoke-repo",
            'echo "installed tugboat --version"',
            ".sidecar/ci/install-smoke-venv/bin/tugboat init --repo .sidecar/ci/proposal-smoke-repo",
            ".sidecar/ci/install-smoke-venv/bin/tugboat optimize --repo .sidecar/ci/proposal-smoke-repo --trace",
    ...
    "docs/quickstart.md": {
        ...
        "required_text": [
            ...
            "tugboat index --repo . --check",
            "python -m pytest --cov=src --cov-report=term-missing -q",
            "CI must not run apply, auto-apply, rollback --execute, or mutation modes.",
            "tugboat optimize --repo . --trace traces/example.jsonl --suite all",
            "tugboat audit --repo . --trace",
            "tugboat propose --repo . --audit latest",
            "optimization-summary.json",
    ...
    "docs/integrations.md": {
        ...
        "required_text": [
            ...
            "Codex fixture proves session metadata, base instruction snapshots, tool calls, and final response events ingest as a canonical episode.",
            "Claude fixture proves transcript JSON/JSONL exports preserve user corrections and assistant responses for drift evidence.",
            "MCP fixture proves tool-call lifecycle events from read-only MCP clients become auditable trace evidence.",
            "CI fixture proves failing command output can feed proposal-only remediation without granting mutation authority.",
            "proposal-only",
